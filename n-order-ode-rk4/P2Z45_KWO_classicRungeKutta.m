function y = P2Z45_KWO_classicRungeKutta(b,a,x0,xN,y0,N)
% Projekt 2, zadanie 45
% Krzysztof Wójtowicz, 339108
%
% Metoda Rungego - Kutty (klasyczna, 4-go rzędu) dla liniowych równań 
...
% Iteracyjny Runge-Kutta, metoda klasyczna
for i = 1:N
    % Liczymy 4 kroki metody klasycznej
    K0 = dF(Y,b,a,k);
    K1 = dF(Y + 0.5*h*K0,b,a,k);
    K2 = dF(Y + 0.5*h*K1,b,a,k);
    K3 = dF(Y + h*K2,b,a,k);
